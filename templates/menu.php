<ul class="nav nav-tabs">
  <hr class="hidden-sm hidden-md hidden-lg"/>
    ...
    <ul class="dropdown-menu">
      ...
      <li role="presentation"><a href="<?php $_SESSION['page'] = $_SESSION['id'].'/'.'user=id_'.$_SESSION['id'].'_appeals-'.$_SESSION['id']; echo 'resources/'.$_SESSION['page'].'.php'; ?>"><span class="glyphicon glyphicon-file"></span> Подача обращения </a></li>
